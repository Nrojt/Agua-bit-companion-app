        ...
        if (sensorType.equals("Temperature sensor")) {
            ...
            if (Double.parseDouble(sensorValue) >= 20 && Double.parseDouble(sensorValue) <= 70) {
                System.out.println(ANSI_RED
                        + "Unsafe"
                        + ANSI_RESET);
            } else if (Double.parseDouble(sensorValue) >= 10 && Double.parseDouble(sensorValue) <= 20 || Double.parseDouble(sensorValue) >= 70 && Double.parseDouble(sensorValue) <= 100) {
                System.out.println(ANSI_GREEN
                        + "Safe"
                        + ANSI_RESET);
            } else if (Double.parseDouble(sensorValue) >= 0 && Double.parseDouble(sensorValue) <= 10) {
