    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (sensorType.equals("Temperature sensor")) {
            if (Double.parseDouble(sensorValue) >= 20 && Double.parseDouble(sensorValue) <= 70) {
                informationArea.setText("If your water is between 20 and 45 degrees. The bacteria can form and multiply faster. Because this is the optimum temperature for bacteria. With water above 45 degrees, it wil get tougher for bacteria to form and the process will also be sluggish.");
                ...
                informationArea.setText("At temperatures above 70á75 degrees, the bacteria die. And you can drink the water the minus point is that the vitamins and minerals can evaporate or reduce in substance.");
            }
        }
